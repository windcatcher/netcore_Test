...
namespace ApiProductService.Controllers
{
    ...
    public class Product1Controller : Controller
    {
        ...
        private readonly ILogger<Product1Controller> _logger;

        public Product1Controller(IOptions<ServiceDisvoveryOptions> options, ILogger<Product1Controller> logger)
        {
            _options = options;
            _logger = logger;
        }
