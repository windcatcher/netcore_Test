...
namespace Resilience.Http
{
    public class ResilientHttpClient : IHttpClient
    {
        ...
        private ConcurrentDictionary<string, PolicyWrap> _pocilyWrappers;
        private readonly IHttpContextAccessor _httpContextAccessor;


        public ResilientHttpClient(ILogger<ResilientHttpClient> logger, Func<string, IEnumerable<Policy>> policyCreator, IHttpContextAccessor httpContextAccessor)
        {
            _logger = logger;
            _httpContextAccessor = httpContextAccessor;
            _client = new HttpClient();
            _pocilyWrappers = new ConcurrentDictionary<string, PolicyWrap>();
